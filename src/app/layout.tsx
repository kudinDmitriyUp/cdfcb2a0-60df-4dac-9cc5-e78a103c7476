...
export const metadata: Metadata = {
  title: "Fresh & Clean Laundry | Professional Local Laundry Service",
  description: "Professional laundry services for families and businesses. Wash, dry cleaning, and ironing with fast turnaround. Free local pickup and delivery.",
  keywords: "laundry service, dry cleaning, wash and fold, local laundry, professional cleaning",
  metadataBase: new URL("https://freshclean.local"),
  alternates: {
    canonical: "https://freshclean.local"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Fresh & Clean Laundry - Your Local Laundry Experts",
    description: "Professional laundry and dry cleaning services with free pickup and delivery",
    type: "website",
    siteName: "Fresh & Clean Laundry",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765886849494-uczdp3rr.jpg",
      alt: "Fresh Clean Laundry Service"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Fresh & Clean Laundry Services",
    description: "Professional laundry, dry cleaning, and ironing services",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765886849494-uczdp3rr.jpg"]
  }
};
